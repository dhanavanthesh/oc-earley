...
def test_interface_torch():
    from oc_earley.kernels.torch import (
...
def test_interface_numpy():
    ...
    from oc_earley.kernels.numpy import (
        allocate_token_bitmask,
        apply_token_bitmask_inplace,
        fill_next_token_bitmask,
    )
...
def test_interface_mlx():
    ...
    from oc_earley.kernels.mlx import (
        allocate_token_bitmask,
        apply_token_bitmask,
        fill_next_token_bitmask,
    )
...
def test_torch_correctness(guide):
    from oc_earley.kernels.torch import _apply_token_bitmask_inplace_kernel
...
def test_numpy_correctness(guide):
    ...
    from oc_earley.kernels.numpy import _apply_token_bitmask_inplace_kernel
...
def test_mlx_correctness(guide):
    ...
    from oc_earley.kernels.mlx import _apply_token_bitmask_kernel
